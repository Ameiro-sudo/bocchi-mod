...
public class ImagesBlockComponent extends AbstractBaseComponent<MainMenuPoulsenFrameContext> {
  ...
  private final ResourceLocation IMAGE_1 = Design.resource("textures.gotoh_image_1");
  private final ResourceLocation IMAGE_2 = Design.resource("textures.gotoh_image_2");
