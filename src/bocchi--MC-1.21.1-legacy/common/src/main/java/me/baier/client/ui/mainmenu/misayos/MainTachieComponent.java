...
public class MainTachieComponent extends AbstractBaseComponent<MainMenuMisayosFrameContext>
  ...
  private final ResourceLocation TACHIE_TEXTURE =
  ...
  public void render(SkiaContext ctx, MainMenuMisayosFrameContext frame) {
    ...
    if (mainGotohImageAnim != null) {
      ...
      SkiaRenderEngine.drawImage(
          ...
          currentImageAlpha,
          paint -> {
            paint.setImageFilter(ImageFilter.makeDilate(1.f, 1.f, null, null));
      ...
      SkiaRenderEngine.drawImage(
          ...
          paint -> {
            paint.setImageFilter(ImageFilter.makeDilate(1.f, 1.f, null, null));
            paint.setColorFilter(ColorFilter.makeBlend(0XFFFFFFFF, BlendMode.SRC_IN));
            // paint.setAntiAlias(true);
          });
      // ctx.stopScale();
      ...
      SkiaRenderEngine.drawImage(
          ...
          paint -> {
            ...
            /* ImageFilter shadowOnlyFilter =
                ImageFilter.makeDropShadow(
                    shadowDx, shadowDy, shadowSigmaX, shadowSigmaY, shadowColor, null, null);
            paint.setImageFilter(shadowOnlyFilter);*/
