...
public class MainMenuMisayosScreen extends Screen {
  ...
  public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float delta) {
    this.root.handleMouseMove(mouseX, mouseY);
  ...
  public boolean mouseClicked(double mouseX, double mouseY, int button) {
    return this.root.handleMouseClick((int) mouseX, (int) mouseY, button);
  }

  @Override
  public boolean mouseReleased(double mouseX, double mouseY, int button) {
    return this.root.handleMouseRelease((int) mouseX, (int) mouseY, button);
  }

  @Override
  public boolean mouseScrolled(double mouseX, double mouseY, double xOffset, double yOffset) {
    return this.root.handleMouseScroll((int) mouseX, (int) mouseY, (int) yOffset);
  }
